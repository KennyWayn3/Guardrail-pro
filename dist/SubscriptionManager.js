...
class SubscriptionManager {
     ...
     */
    async fetchSubscriptionFromBillingBackend(apiKey) {
        try {
            ...
            if (apiKey.startsWith('ent_'))
                return { valid: true, tier: 'Enterprise', remainingCalls: Infinity };
            if (apiKey.startsWith('pro_'))
                return { valid: true, tier: 'Pro', remainingCalls: 1000 };
            if (apiKey.startsWith('free_'))
                return { valid: true, tier: 'Free', remainingCalls: 5 };
     ...
     */
    async trackUsage(apiKey, toolName) {
